...
st.markdown("Online Shoppers Purchasing Intention")
...
xres = st.sidebar.slider("Feature 1", 100, 1000, 100, 100)
w0 = st.sidebar.slider("Feature 2", 0.0, 10.0, 1.0, 0.5)
w1 = st.sidebar.slider("Feature 3", 0.0, 10.0, 1.0, 0.5)
w2 = st.sidebar.slider("Feature 4", 0.0, 10.0, 1.0, 0.5)
w = Weight(w0, w1, w2)
